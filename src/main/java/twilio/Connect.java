...
public class Connect extends HttpServlet {
	...
	/**
	 * Method that handles /connect request and responds with the TwiML after
	 * validating the authenticity of the request
	 * 
	 * @param request
	 *            incoming servlet request object
	 * @param response
	...
	private String getXMLResponse() {
		...
		Say sayMessage = new Say("Test call Code for Good");
	...
	/**
	 * Uses TwilioUtils to validate that the incoming request comes from Twilio
	 * automated services
	 * 
	 * @param request
	 *            passed servlet request to extract parameters necessary for
	 *            validation
